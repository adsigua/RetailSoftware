...
{
    public partial class ReportsSubMenuForm : SubMenuForm
    {
        public ReportsSubMenuForm()
        {
            InitializeComponent();
        }
        public ReportsSubMenuForm(MainForm mf)
        {
            InitializeComponent();

            mainForm = mf;
            subMenuButtons = ControlHandler.GetChildControls(tblpSubFormReports, typeof(CheckBox))
